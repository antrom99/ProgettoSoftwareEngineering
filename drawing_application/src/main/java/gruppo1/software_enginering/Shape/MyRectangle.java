...
public class MyRectangle implements MyShape {
    ...
    public void draw(GraphicsContext drawingSurface) {
        ...
        if(fill){
            drawingSurface.fillRect(this.startPointforDrawing().getX(), this.startPointforDrawing().getY(), this.getWidth(), this.getHeigth());
        }
        drawingSurface.strokeRect(this.startPointforDrawing().getX(), this.startPointforDrawing().getY(), this.getWidth(), this.getHeigth());
